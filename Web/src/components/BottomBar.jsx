    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={zoom.toString()} onValueChange={(value) => onZoomChange(Number(value))}>
          ...
          >
            <SelectItem value="25" style={{ color: 'var(--editor-text)' }}>
              25%
            </SelectItem>
            <SelectItem value="50" style={{ color: 'var(--editor-text)' }}>
              50%
            </SelectItem>
            <SelectItem value="75" style={{ color: 'var(--editor-text)' }}>
              75%
            </SelectItem>
            <SelectItem value="100" style={{ color: 'var(--editor-text)' }}>
              100%
            </SelectItem>
            <SelectItem value="125" style={{ color: 'var(--editor-text)' }}>
              125%
            </SelectItem>
            <SelectItem value="150" style={{ color: 'var(--editor-text)' }}>
              150%
            </SelectItem>
            <SelectItem value="200" style={{ color: 'var(--editor-text)' }}>
              200%
            </SelectItem>
          </SelectContent>
        </Select>
